...
const NETWORK_CONFIGS: Record<number, NetworkConfig> = {
  ...
  [CHAIN_IDS.BASE_TESTNET]: {
    ...
    contractAddress: "0x2D323Db44D022601885e2e34f0767293d02B704C",
 ...
 */
export function getUsdcToken(chainId: number | string): string | null {
...
const NETWORK_SELECT_KEYS: Record<number, string> = {
 ...
 */
export function getNetworkSelectKey(chainId: number | string): string | null {
 ...
 */
export function getSupportedNetworkSelectKeys(): string[] {
