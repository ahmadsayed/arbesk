 ...
 */
export function computeGltfBounds(gltf) {
 ...
 * @returns {{min: number[], max: number[], size: number[]} | null}
 */
export function boundsFromGlbBytes(bytes) {
 ...
 * @param {{size: number[]} | null} sourceBounds
 * @param {{size: number[]} | null} resultBounds
 * @returns {number | null}
 */
export function compensationScale(sourceBounds, resultBounds) {
