 ...
 */
import { publishCollection } from "../../domain/collection.ts";
import type { PublishCollectionResult } from "../../domain/collection.ts";
import { adoptPublishedIdentity } from "../../domain/asset.ts";
