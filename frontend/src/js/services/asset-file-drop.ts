...
} from "../engine/cleanup.ts";
import { clearPendingSourceColorEdit } from "../engine/parametric-preview.ts";
...
async function _handleAssetFileDropped(detail: any): Promise<void> {
