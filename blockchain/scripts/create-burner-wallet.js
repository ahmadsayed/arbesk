...
console.log("   https://docs.megaeth.com/builders/tools/faucets");
console.log("4. Check balances at:");
console.log(`   https://megaexplorer.xyz/address/${deployer.address}`);
console.log(`   https://megaexplorer.xyz/address/${treasury.address}`);
