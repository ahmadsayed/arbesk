...
const RULES = [
  ...
  "A desk phone or tablet stand is phoneStand({ thickness, lift, width }) - use it",
  "rather than drawing one. Its profile is a ported, hand-tuned reference design",
  "that has to be credited (see ATTRIBUTED_HELPERS); every attempt to have a model",
  "draw this shape produced something that was one solid and still not a stand.",
  "A STAND OR HOLDER IS ONE SOLID, NOT AN ASSEMBLY. Draw the SIDE PROFILE as a",
  "single 2D outline - a U or L channel with a lip at the front, a foot at the",
  "back - then extrude it ACROSS the width of the thing it holds. The phone or",
