...
The audit covers every user-facing surface in the Arbesk Studio shell:

| Surface | Files audited | What's checked |
|---------|--------------|----------------|
| Color system | `arabesk/frontend/src/scss/base/_tokens.scss` | Contrast ratios, semantic color use, dark/light parity |
| Buttons | `arabesk/frontend/src/scss/components/_buttons.scss` | Sizing, states, icon-only patterns |
| Forms | `arabesk/frontend/src/scss/components/_forms.scss` | Labels, focus rings, placeholder contrast |
| Header bar | `arabesk/frontend/src/scss/components/_headerbar.scss` | Layout, title area, wallet button |
| Sidebar | `arabesk/frontend/src/scss/components/_sidebar.scss` | View switcher, collapsible behavior |
| Inspector | `arabesk/frontend/src/scss/components/_inspector.scss` | Panel layout, transform controls |
| Message bar | `arabesk/frontend/src/scss/components/_messagebar.scss` | Input sizing, submit button |
| Bottom bar | `arabesk/frontend/src/scss/components/_bottombar.scss` | Status layout, wallet |
| Cards | `arabesk/frontend/src/scss/components/_cards.scss` | Library cards, badges |
| Dialog | `arabesk/frontend/src/scss/components/_dialog.scss` | Backdrop, title/body/actions pattern |
| Layout | `arabesk/frontend/src/scss/components/_layout.scss` | Flex grid, overflow |
| Responsive | `arabesk/frontend/src/scss/utilities/_responsive.scss` | Breakpoints, touch targets |
| Markup | `arabesk/frontend/src/pug/studio.pug` | ARIA attributes, heading hierarchy |
| Keyboard | `arabesk/frontend/src/js/engine/scene-graph.js` | Shortcut coverage, guard patterns |
| Dialogs (JS) | `arabesk/frontend/src/js/ui/dialog.js` | Focus trap, Escape dismiss |
| Nesting | `arabesk/frontend/src/js/ui/nesting.js` | Alt+Left, Escape ascend |
| Sidebar (JS) | `arabesk/frontend/src/js/ui/sidebar.js` | Toggle, view switching |
