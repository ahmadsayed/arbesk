...
| Phase 5.3: Merkle Editor Proofs | ✅ Complete | `editorRoot`/`editorSetVersion` in `ArbeskAssetBase.sol`, `packages/asset-core/src/gltf/merkle-editors.ts`, `frontend/src/js/services/team.ts` |
